...
public class WelcomePageObject extends MainPageObject
{
    ...
    public void waitForAddedOrEditPreferredLangText()
    {
        this.waitForElementPresent(By.id(STEP_ADD_OR_EDIT_PREFERRED_LANG_LINK), "Cannot find 'Add or edit preferred languages' text", 10);
    }
